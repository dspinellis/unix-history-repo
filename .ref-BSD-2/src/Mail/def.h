...
struct cmd {
	...
	flag_t	c_argtype;		/* Type of arglist (see below) */
	flag_t	c_msgflag;		/* Required flags of messages */
	flag_t	c_msgmask;		/* Relevant flags of messages */
};
...
#define	GSUBJ	2		/* Likewise, Subj: line */
