...
static char Config[] = "@(#)Config: MH.bsd44";

char *options[] = {"BIND", "BPOP", "BSD42", "BSD43", "BSD44", "DBMPWD", "GCOS_HACK", "MHE", "MHRC", "MIME", "MORE='\"/usr/bin/more\"'", "NNTP", "NORUSERPASS", "NTOHLSWAP", "OVERHEAD", "POP", "POP2", "POPSERVICE='\"pop3\"'", "POSIX", "RPOP", "SENDMTS", "SMTP", "SPRINTFTYPE=int", "SYS5DIR", "TYPESIG=void", "UNISTD", "VSPRINTF", "WAITINT", "WHATNOW", "ZONEINFO", NULL};
...
char   *mhlibdir = "/usr/contrib/mh-6.8/lib";	/* NB: this will change */
