...
7     |7|7|7|7|7|7|7|7|7|7|7|
   ...
   _9._1.  _g_e_n_e_r_a_l  _a_r_r_a_y_s    Suppose  the  evaluator  is  told  to  evaluate
      (_f_o_o _a _b)  and  the function cell of the symbol foo contains an array
      object (which we will call foo_arr_obj).  First  the  evaluator  will
      evaluate  and  stack  the  values of _a and _b.  Next it will stack the
...
9   []A lexpr is a function which accepts any number of arguments which  are
...
Arrays                                                                  9-2
      ...
      ments  in the array.  For example, (_s_t_o_r_e (_f_o_o _a _b) _c) will automati-
      cally expand to (foo c a b) and  when  the  evaluator  is  called  to
      evaluate  this,  it  will evaluate the arguments _c, _b and _a.  Then it
   ...
   _9._2.  _s_u_b_p_a_r_t_s _o_f _a_n _a_r_r_a_y _o_b_j_e_c_t   When an array is created a raw array
      object  is allocated with _m_a_r_r_a_y and the user is responsible for fil-
      ...
      _9._2._1.  _a_c_c_e_s_s _f_u_n_c_t_i_o_n   The function of  the  access  function  has
         ...
         contains a function definition.  This subpart  is  used  by  _e_v_a_l,
         _f_u_n_c_a_l_l, and _a_p_p_l_y when evaluating array references.




      _9._2._2.  _a_u_x_i_l_i_a_r_y   This can be used for any purpose. If it is a list
      ...
      _9._2._3.  _d_a_t_a   This is either nil or points to a block of data  space
         allocated by _s_e_g_m_e_n_t or _s_m_a_l_l-_s_e_g_m_e_n_t.




      _9._2._4.  _l_e_n_g_t_h   This is a fixnum whose value is the number  of  ele-
         ments  in  the  data block.  This is used by the garbage collector
         and by _a_r_r_a_y_r_e_f to determine if your index is in bounds.
...
Arrays                                                                  9-3
      ...
      _9._2._5.  _d_e_l_t_a   This is a fixnum whose value is the number  of  bytes
         ...
         This is used by the garbage collector and _a_r_r_a_y_r_e_f as well.
   ...
   _9._3.  _T_h_e _M_a_c_l_i_s_p _c_o_m_p_a_t_i_b_l_e _a_r_r_a_y _p_a_c_k_a_g_e
      ...
      created by a call to the function _a_r_r_a_y or *array .  The only differ-
      ence is that *_a_r_r_a_y evaluates its arguments.  This call: (_a_r_r_a_y _f_o_o _t
      _3 _5) sets up an array called foo of dimensions  3  by  5.   The  sub-
      scripts  are  zero based. The first element is (_f_o_o _0 _0), the next is
      (_f_o_o _0 _1) and so on up to (_f_o_o _2 _4).  The t indicates a general  lisp
      ...
      pointer  to a lisp object, not the object itself.  _A_r_r_a_y does this by
      allocating an array object with _m_a_r_r_a_y and then allocating a  segment
      of  15  consecutive  value  cells  with  _s_m_a_l_l-_s_e_g_m_e_n_t  and storing a
      ...
      cell of the symbol foo.  Now when (_f_o_o _1 _3) is evaluated,  the  array
      ...
      ment (_f_o_o _1 _3) refers to  and uses arrayref to extract that  element.
      ...
      and return it as the value of (_f_o_o _1 _3).

           In Maclisp the call (_a_r_r_a_y _f_o_o _f_i_x_n_u_m _2_5) returns an array whose
...
9   []Aliasing is when two variables are share the  same  storage  location.
For   example   if   the   copying   mentioned   weren't  done  then  after
(_s_e_t_q _x (_f_o_o _2)) was done, the value of x and (foo 2) would share the  same
...
____________________
9location.   Then should the value of (foo 2) change, x's value would change
