 ...
 */
#define BIN "/usr/src/contrib/perl-4.019/bin"             /**/
 ...
 */
#define SCRIPTDIR "/usr/src/contrib/perl-4.019/bin"             /**/
 ...
 */
#define PRIVLIB "/usr/src/contrib/perl-4.019/lib"		/**/
