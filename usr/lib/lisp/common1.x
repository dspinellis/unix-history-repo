...
(load lambda fasl-a-file load-a-file filestat:mtime lessp filestat probef concat memq status quote getchar and <& < cadr >& > |1+| cdr return car eq null exploden nreverse do tilde-expand setq let error stringp symbolp or not cond)
...
(copy lambda cdr car copy cons dtpr not cond)
