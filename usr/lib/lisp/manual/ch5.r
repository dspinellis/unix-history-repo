...
name is taken to be the current user.
     ...
     Having gone to the effort  of  searching  the  password
file,  FRANZ  LISP  remembers the user directory, in case it
gets asked to do so again.  Tilde-expansion is performed  in
the   following   functions:   _c_f_a_s_l,  _c_h_d_i_r,  _f_a_s_l,  _f_f_a_s_l,
...
_f_i_l_e_o_p_e_n,  _i_n_f_i_l_e,  _l_o_a_d,   _o_u_t_f_i_l_e,   _p_r_o_b_e_f,   _s_y_s:_a_c_c_e_s_s,
_s_y_s:_u_n_l_i_n_k.
...
(infile 's_filename)
     ...
     NOTE: to allow your program to continue on a  file-not-
           ...
           function named _p_r_o_b_e_f.
