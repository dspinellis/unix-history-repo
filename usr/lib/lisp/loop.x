...
(loop-do-while lambda quote cons loop-pseudo-body list error loop-simple-error and loop-get-form setq)
...
(loop-nodeclare lambda append error loop-simple-error typep eq and or cdr setf car prog1 pop loop-pop-source setq)
(loop-do-initially lambda loop-get-form cons setq setf push)
(loop-emit-body lambda loop-pseudo-body quote setq)
(loop-pseudo-body lambda cons setf push null not cond loop-make-conditionalization setq)
