#ifndef lint
static char *rcsid =
   "$Header: /na/franz/franz/RCS/lam1.c,v 1.1 83/01/29 13:03:53 jkf Exp $";
#endif

/*					-[Sat Jan 29 13:01:16 1983 by jkf]-
 * 	lam1.c				$Locker:  $
 * lambda functions
 *
...
Lequal()
{
	...
	lispval Lsub(),Lzerop(), *stack(), unstack();
	char *oldsp, *sp();
	chkarg(2,"equal");
    ...
    again:
	    ...
	    switch(type1) {
	    case DTPR:
		stack(first->d.cdr); stack(second->d.cdr);
