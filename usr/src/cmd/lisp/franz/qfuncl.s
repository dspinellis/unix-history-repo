...
# constants from the lisp system
#  types
	.set	strng,0
	.set 	atom,1
	.set	bcd,5
...
# important offsets withing data types
# for atoms
	.set	atomclb,0
	.set	atomfnbnd,8
...
doarray:
	ashl	$-9,araccfun(r2),r3	# get access function addr shifted
...
# _qoneplus adds one to the boxed fixnum in r0 and returns a boxed fixnum.
#
	.globl	_qoneplus
_qoneplus:
	addl3	(r0),$1,r5
...
_qprunei:
	...
	cmpl	r0,start		# is it a small fixnum
