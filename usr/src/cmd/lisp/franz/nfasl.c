static char *sccsid = "@(#)nfasl.c	35.2 7/7/81";
...
int qnewdoub(),qoneplus(),qoneminus();
...
lispval Lnfasl()
{
	...
	*/
	...
	code_core_org = (char *) csegment(str_name,segsiz/(sizeof(int)),TRUE);
