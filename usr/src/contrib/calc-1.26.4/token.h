...
#define T_PRINT			110	/* print keyword */
...
extern long tokennumber();
extern void inittokens();       /* initialize all token information */
extern void tokenmode();
extern int gettoken();
extern void rescantoken();
