...
(defvar news-path "/var/spool/news/"
...
(defvar mh-progs
  (cond ((file-exists-p "/usr/contrib/mh/bin/") "/usr/contrib/mh/bin/")
...
(defvar mh-lib
  (cond ((file-exists-p "/usr/contrib/mh/lib") "/usr/contrib/mh/lib")
...
(defconst sendmail-program
  (if (file-exists-p "/usr/sbin/sendmail")
      "/usr/sbin/sendmail"
...
(defconst manual-program "/usr/bin/man"
...
(defconst manual-formatted-dirlist
  (cond ((eq system-type 'hpux)
	 ...
	 ((file-exists-p "/usr/share/man/cat1")
	  '("/usr/share/man/cat1" "/usr/share/man/cat2" "/usr/share/man/cat3"
	    "/usr/share/man/cat4" "/usr/share/man/cat5" "/usr/share/man/cat6"
	    "/usr/share/man/cat7" "/usr/share/man/cat8" "/usr/share/man/catl"
	    "/usr/share/man/catn"))
	 (t
