...
/* $Header: XMenuPost.c,v 10.5 86/02/12 16:19:49 tony Rel $ */
...
char *
XMenuPost(menu, p_num, s_num, x_pos, y_pos, event_mask)
    ...
    int event_mask;		/* Mouse button event mask. */
{
    ...
    *s_num = 0;
    ...
    /*
     * Make the proceedure call.
     */
    stat = XMenuActivate(menu, p_num, s_num, x_pos, y_pos, event_mask, &data);
