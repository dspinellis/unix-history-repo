# ifndef lint
static char	SccsId[] = "@(#)SendMail version 3.327 of 3/12/83";
# endif lint
...
alias.o:
	alias.c	3.46		3/10/83	(with DBM)
deliver.o:
	deliver.c	3.149		2/20/83
savemail.o:
	savemail.c	3.60		3/8/83
err.o:
	err.c	3.40		1/5/83
readcf.o:
	readcf.c	3.56		2/8/83
stab.o:
	stab.c	3.14		2/2/83
headers.o:
	headers.c	3.54		3/12/83
recipient.o:
	recipient.c	3.52		3/8/83
stats.o:
	stats.c	3.5		11/28/82
daemon.o:
	daemon.c	3.51		2/26/83	(with daemon mode)
usersmtp.o:
	usersmtp.c	3.42		2/20/83
srvrsmtp.o:
	srvrsmtp.c	3.47		2/18/83
queue.o:
	queue.c	3.72		3/12/83
macro.o:
	macro.c	3.20		2/3/83
util.o:
	util.c	3.43		2/24/83
...
trace.o:
	trace.c	3.1		8/8/82
envelope.o:
	envelope.c	3.12		3/8/83
sysexits.o:
	sysexits.c	3.6		1/4/83
bmove.o:
	bmove.c	3.4		5/31/82
arpadate.o:
	arpadate.c	3.11		1/12/83
convtime.o:
	convtime.c	3.3		11/28/82
