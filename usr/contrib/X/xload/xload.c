 ...
 */
#ifndef lint
static char *rcsid_xload_c = "$Header: xload.c,v 10.9 86/02/01 16:00:54 tony Rel $";
#endif  lint
    ...
    char **argv;
{
	...
	xload_error("cannot open display");
	...
	border_pixmap = XMakePixmap ((Bitmap) XStoreBitmap (16, 16, gray_bits),
