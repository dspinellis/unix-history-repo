-- $Header: Printing3.cr,v 2.0 85/11/21 07:24:34 jqj Exp $ --
...
-- $Log:	Printing3.cr,v $
-- Revision 2.0  85/11/21  07:24:34  jqj
...
MediumUnavailable: ERROR = 5; -- the service is not accepting any remote procedure calls --
