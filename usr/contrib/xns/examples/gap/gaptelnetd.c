#ifndef lint
static char RCSid[] = "$Header: gaptelnetd.c,v 2.0 85/11/21 07:23:06 jqj Exp $";
#endif
/*
	...
	Authentication1_Verifier verifier;
{
	...
	case oldTty:
	case oldTtyHost:
		frametimeout = sessionparams.oldTtyHost_case.frameTimeout/1000;
	...
	case service:
		servicetype = transports.sequence[0].service_case.id;
		switch (servicetype) {
