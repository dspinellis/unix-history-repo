...
/* CLEANUP is an expression to be executed at exit from this binding contour;
   ...
   Return 0 if such an expansion is invalid.  Otherwise, return 1.  */
int
...
#if 0
  /* Not yet defined in GCC 1.37.1.  */

  /* Tell final that the parameters are in the final places
     (either on the stack or in registers).  */
  emit_note ((char *) 0, NOTE_INSN_PARMS_HOMED);
#endif
