/* $RCSfile: stab.c,v $$Revision: 1.2 $$Date: 1992/05/15 14:09:40 $
 *
 ...
 *
 * $Log: stab.c,v $
 * Revision 1.2  1992/05/15  14:09:40  rich
 * use the system malloc
 *
 * Revision 1.1  1992/05/15  04:50:11  rich
 * Initial revision
 *
...
STR *str;
{
    ...
    case 'E':
	setenv(mstr->str_ptr,str_get(str),1);
	...
	case '0':
		...
		if (origenviron[0] == s + 1) {	/* can grab env area too? */
		    setenv("NoNeSuCh", Nullch,1); /* force copy of environment */
