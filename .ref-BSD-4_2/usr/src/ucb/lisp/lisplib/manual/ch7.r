...
Notice what happened to
 ! _w_y_o_m_i_n_g.  Since it wasn't in the table, the  macro  prob-
ably  didn't  want  to return anything at all, but it had to
return something, and whatever it returned was  put  in  the
...
list.   The splicing macro, described next, allows a charac-
ter macro function to return a value that is ignored.
