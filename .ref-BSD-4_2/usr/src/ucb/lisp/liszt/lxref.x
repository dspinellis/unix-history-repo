...
(generate-xref-file lambda cdar flatc + terprchk memq print not terpr msg-print progn msg nreverse or liszt-internal-do mapcar patom typeit ncons cxr getd cdr cadar caar concat cons sortcar length lessp cond If get car null do quote sort setq)
