...
#ifndef HOME
#define	ROOTID	1	/* uid of person allowed to cancel anything	*/
#endif
...
#define INEWS	"/usr/new/inews"/* inews for recnews to fork	*/
#define FOLLOWUP INEWS
#define RNEWS	"/usr/new/rnews"/* rnews for uurec to fork	*/
...
#define BATCH "/usr/new/lib/news/unbatch" /* name of unbatcher 		*/
...
#define MYORG "U.C. Berkeley"	/* My organization.  Please	*/
...
#define SYSPATH	"PATH=/usr/new:/usr/ucb:/bin:/usr/bin"
			/* default, secure, vanilla path */
