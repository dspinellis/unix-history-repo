...
static void o_indexvalue(), o_assign(), o_add(), o_sub(), o_mul(), o_div();
...
static void o_matinit(), o_ismat(), o_isstr(), o_getconfig(), o_predec();
...
static void o_objinit(), o_isobj(), o_norm(), o_elemaddr(), o_elemvalue();
...
static void o_printresult(), o_isfile();
