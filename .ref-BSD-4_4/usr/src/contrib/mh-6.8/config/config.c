...
char *options[] = {"BIND", "BPOP", "BSD42", "BSD43", "BSD44", "DBMPWD", "MHE", "MHRC", "MIME", "MORE='\"/usr/bin/more\"'", "NNTP", "NTOHLSWAP", "OVERHEAD", "POP", "POP2", "POPSERVICE='\"pop3\"'", "POSIX", "RPOP", "SENDMTS", "SMTP", "SPRINTFTYPE=int", "SYS5DIR", "TYPESIG=void", "UNISTD", "VSPRINTF", "WAITINT", "WHATNOW", "ZONEINFO", NULL};
