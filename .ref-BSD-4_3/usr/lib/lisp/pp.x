...
($prpr lambda pp-form)
(pp-form lambda $prdf setq)
(condclosefile lambda setq close terpr cond)
(pp-prop lambda quote list pp-form)
(pp-function lambda list pp-form or msg-print terpr progn msg quote get bcdp caadr memq cadr dtpr and cond)
(pp-value lambda quote list pp-form)
(pp nlambda get terpri or msg-print progn msg bcdp not cxr getd list apply boundp and eq cdr liszt-internal-do mapc go pp-form outfile cadr eval quote equal dtpr return terpr condclosefile car null cond setq prog)
