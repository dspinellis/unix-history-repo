...
/* $Header: XMenuInternal.c,v 10.17 86/02/01 16:15:10 tony Rel $ */
 ...
 */
typedef struct _xm_win_que_def {
    int sq_size;
    ...
    int *orig_y;		/* Return value Y coord. of the menu origin. */
{
    ...
    /*
     * First translate to the upper left of the current selection window.
     */
