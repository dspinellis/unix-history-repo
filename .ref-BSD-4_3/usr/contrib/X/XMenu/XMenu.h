...
/* $Header: XMenu.h,v 10.18 86/02/01 16:14:03 tony Rel $ */
...
typedef struct _xmenu {
    ...
    FontInfo *p_fnt_info;	/* Flag font info structure. */
    ...
    FontInfo *s_fnt_info;	/* Body font info structure. */
