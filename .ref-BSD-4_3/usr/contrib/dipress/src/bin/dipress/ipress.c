 ...
 *
 * History:
 *	John Mellor-Crummey 28-aug-1985 restructuring and minor modifications
 *
 *	ed flint 10-may-1985	coerce device.num_char_wid to unsigned char, change
...
setPointSize(n)		/* set point size to n */
