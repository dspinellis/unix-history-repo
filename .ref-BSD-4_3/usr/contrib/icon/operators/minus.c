...
struct descrip arg2, arg1, arg0;
   ...
   if (t1 == T_LONGINT && t2 == T_LONGINT)
      /*
       * Both x and y are integers.  Perform integer subtraction using
       *  cksub (to check for overflow) and place the result in arg0 as
       *  the return value.
       */
      mkint(cksub(n1.integer, n2.integer), &arg0);
   else {
      /*
