...
to the first SBIA on the 8650 and 8600.
.PP
...
Temporarily
set the reboot switch on an 11/785, 11/780, or 11/730 to off;
on an 8650, 8600, or 11/750 set the power-on action to halt.
(In normal operation an 11/785, 11/780, or 11/730
will have the reboot switch on,
and an 8650, 8600, or 11/750 will have the power-on action
set to boot/restart.)
.PP
...
given in this section refer to the first SBIA on the 8650 and 8600.
...
\fB>>>\|\fPD + 20010000		(8650/8600/785/780 mba0)
...
\fB>>>\|\fPD + 6B
        (The next two deposits set up the addresses of the MASSBUS)
        (adapter and the drive number for the tape formatter)
        (the 20012000 here is the address of mba1 on an 8650, 8600, 11/785)
	(or 11/780 and the 0 indicates the formatter is drive 0 on mba1)
\fB>>>\|\fPD + 20012000
\fB>>>\|\fPD + 0
\fB>>>\|\fPS 200
\fB>>>\|\fPS 200
...
.TS
lw(1.5i) l.
\fB>>>\|\fPD/G A 20006000	(for tapes on 8650/8600/785/780 uba0)
\fB>>>\|\fPD/G A 20008000	(for tapes on 8650/8600/785/780 uba1)
\fB>>>\|\fPD/G A 20010000	(for tapes on 8650/8600/785/780 mba0)
\fB>>>\|\fPD/G A 20012000	(for tapes on 8650/8600/785/780 mba1)
...
\fB>>>\|\fPD/G B 2013F550	(for TM11/TS11/TU80 tapes on 8650/8600/785/780 uba0)
