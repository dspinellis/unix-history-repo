...
vectors  of fixnums, flonums or general lispvalues.  This is
...
Arrays                                                   9-2
      ...
      Pascal.
           ...
           The array access function will also be called  up
      to   store   elements  in  the  array.   For  example,
      ...
      tion  which it can by checking the number of arguments
      it has been given (a lexpr can do this very easily).




   _9._2.  _s_u_b_p_a_r_t_s _o_f _a_n _a_r_r_a_y  _o_b_j_e_c_t    When  an  array  is
      created  a  raw  array object is allocated with _m_a_r_r_a_y
      and the user is responsible for filling in the  parts.
      Certain  lisp  functions  interpret  the values of the
      subparts of  the  array  object  in  special  ways  as
      described  in  the  following  text.   Placing illegal
      values in these subparts may cause the lisp system  to
      fail.




      _9._2._1.  _a_c_c_e_s_s _f_u_n_c_t_i_o_n   The function of  the  access
      ...
      _9._2._2.  _a_u_x_i_l_i_a_r_y   This can be used for any  purpose.
...
Arrays                                                   9-3
      ...
      _9._2._3.  _d_a_t_a   This is either nil or points to a block
      ...
      _9._2._4.  _l_e_n_g_t_h   This is a fixnum whose value  is  the
      ...
      _9._2._5.  _d_e_l_t_a   This is a fixnum whose  value  is  the
   ...
   _9._3.  _T_h_e _M_a_c_l_i_s_p _c_o_m_p_a_t_i_b_l_e _a_r_r_a_y _p_a_c_k_a_g_e
           ...
           A Maclisp style array is similar to what are know
      ...
      created  by  a  call to the function _a_r_r_a_y or *array .
...
Arrays                                                   9-4
      ...
      value cell whose value what we want,  so  we  evaluate
      ...
      actual  numbers  are  be stored instead of pointers to
      the numbers as are done in general lisp object arrays.
      ...
      comes  extra cost; if you just want a simple vector of
      (less than 128) general lisp objects you would be wise
      to look into using hunks.
