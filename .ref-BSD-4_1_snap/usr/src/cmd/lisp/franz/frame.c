static char *sccsid = "@(#)frame.c	1.1 7/1/81";

#include "global.h"
#include "frame.h"

/* 
 * frame.c :: a collection of routines for manipulating evaluation frames.
 ...
 *
 *   errp = Pushframe(class);	 create and link in new frame of give class
 *
 * If the frame has arguments, then the the call should be:
 *   errp = Pushframe1(class,arg); 
 *	- or -
 *   errp = Pushframe2(class,arg1,arg2);
 *
 ...
 * which makes sense.  For example, coming out of a Pushframe1(F_CATCH,tag);
...
lispval arg1,arg2;
{
    ...
    switch(class)
    {
    case C_GO: errorh(Vermisc, "No prog to go to with this tag ",
			       nil,FALSE,0,arg1);
		/* NOT REACHED */
    ...
    case C_THROW: errorh(Vermisc, "No catch for this tag ", nil, FALSE , 0,
				  arg1);
		/* NOT REACHED */
