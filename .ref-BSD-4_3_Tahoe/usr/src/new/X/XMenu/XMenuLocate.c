...
/* $Header: XMenuLocate.c,v 10.5 86/07/11 16:49:17 tony Rel $ */
...
int
XMenuLocate(menu, p_num, s_num, x_pos, y_pos, ul_x, ul_y, width, height)
    ...
    int *height;		/* Returned menu height. */
{
     ...
     */
    _XMTransToOrigin(menu, p_ptr, s_ptr, x_pos, y_pos, ul_x, ul_y);
